...
CREATE TABLE `oauth2_provider_grant` (
  ...
  KEY `oauth2_provider_grant_user_id_e8f62af8_fk_commerce_user_id` (`user_id`),
  CONSTRAINT `oauth2_provider_gran_application_id_81923564_fk_oauth2_pr` FOREIGN KEY (`application_id`) REFERENCES `oauth2_provider_application` (`id`),
  CONSTRAINT `oauth2_provider_grant_user_id_e8f62af8_fk_commerce_user_id` FOREIGN KEY (`user_id`) REFERENCES `commerce_user` (`id`)
...
-- Dump completed on 2024-05-07 18:51:25
